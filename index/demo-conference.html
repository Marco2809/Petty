				...
				<div class="container">
					<div class="header-row justify-content-lg-between">
						...
						<div id="logo" class="me-lg-0">
							<a href="#" data-scrollto="#slider" class="standard-logo" data-dark-logo="demos/conference/images/logo-dark.png"><img src="demos/conference/images/logo.png" alt="Canvas Logo"></a>
							<a href="#" data-scrollto="#slider" class="retina-logo" data-dark-logo="demos/conference/images/logo-dark@2x.png"><img src="demos/conference/images/logo@2x.png" alt="Canvas Logo"></a>
						</div><!-- #logo end -->
							...
							<div class="widget clearfix">
								<div class="row clearfix">
									<div class="col-lg-8 bottommargin-sm clearfix" style="color:#888;">
										<img src="demos/app-landing/images/logo-dark@2x.png" alt="Canvas Logo" style="display: block;" height="100">
